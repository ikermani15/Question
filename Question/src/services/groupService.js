...
async function callGroupJoin(body) {
...
export const identifyUser  = (username, pin) =>
  callGroupJoin({ action: "identify", username, pin })

export const createGroup   = (groupName, username, pin) =>
  callGroupJoin({ action: "create", groupName, username, pin })

export const joinGroup     = (groupCode, username, pin) =>
  callGroupJoin({ action: "join", groupCode, username, pin })

export const kickParticipant = (participantId, groupId, requesterUsername) =>
  callGroupJoin({ action: "kick", participantId, groupId, requesterUsername })
...
export async function deleteGroup(groupId, requesterUsername) {
